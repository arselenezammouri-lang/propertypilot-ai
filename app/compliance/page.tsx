      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-purple-500/30 to-cyan-500/30 flex items-center justify-center border border-primary/30">
          ...
          <Card className="border-border bg-card">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <CardTitle className="text-lg text-foreground">{t.encTitle}</CardTitle>
              </div>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-border bg-card">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <CardTitle className="text-lg text-foreground">{t.gdprTitle}</CardTitle>
              </div>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-gray-300">
          ...
          <Card className="border-border bg-card">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <CardTitle className="text-lg text-foreground">{t.certTitle}</CardTitle>
              </div>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-gray-300">
        ...
        <Card className="border-border bg-card mb-8">
          <CardHeader>
            <CardTitle className="text-xl text-foreground">{t.countryTitle}</CardTitle>
            <CardDescription>
              {t.countryDesc}
            </CardDescription>
          </CardHeader>
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    {doc.available ? (
                      ...
                      <Badge variant="outline" className="border-border text-muted-foreground/60">
                        {t.comingSoon}
                      </Badge>
                    )}
                  </div>
