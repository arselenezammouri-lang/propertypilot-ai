      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-bold text-foreground">{t.programTitle}</h1>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center gap-2">
              <Input
                value={referralLink}
                readOnly
                className="bg-[#111111] border-border text-foreground font-mono text-sm"
              />
              <Button
                onClick={handleCopy}
                type="button"
                variant="outline"
                size="icon"
                className="border-border hover:bg-amber-500/10"
          ...
          <Card className="border-border bg-card">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <CardTitle className="text-lg text-foreground">{t.invitedFriends}</CardTitle>
              </div>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-border bg-card">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <CardTitle className="text-lg text-foreground">{t.discountsEarned}</CardTitle>
              </div>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-border bg-card">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <CardTitle className="text-lg text-foreground">{t.potentialEarnings}</CardTitle>
              </div>
            </CardHeader>
            <CardContent>
        ...
        <Card className="border-border bg-card">
          <CardHeader>
            <CardTitle className="text-xl text-foreground">{t.howItWorks}</CardTitle>
          </CardHeader>
          <CardContent>
            <ol className="space-y-4 text-gray-300">
              <li className="flex items-start gap-3">
                <Badge className="bg-purple-500 text-foreground w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">1</Badge>
                <div>
                  <p className="font-semibold text-foreground mb-1">{t.step1Title}</p>
                  <p className="text-sm text-gray-400">{t.step1Desc}</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <Badge className="bg-purple-500 text-foreground w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">2</Badge>
                <div>
                  <p className="font-semibold text-foreground mb-1">{t.step2Title}</p>
                  <p className="text-sm text-gray-400">{t.step2Desc}</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <Badge className="bg-purple-500 text-foreground w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">3</Badge>
                <div>
                  <p className="font-semibold text-foreground mb-1">{t.step3Title}</p>
