...
export default function LeadsPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="glass border-b border-border sticky top-0 z-50 animate-fade-in-down backdrop-blur-2xl">
                      ...
                      <TableRow 
                        ...
                        className={`cursor-pointer hover:bg-muted/50 ${
                          lead.lead_score > 90 
                            ...
                            : lead.lead_score >= 85 
                            ? 'bg-gradient-to-r from-amber-500/10 to-orange-50 border-l-4 border-amber-500' 
                            : ''
                        }`}
