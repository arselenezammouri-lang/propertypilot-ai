  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground flex items-center gap-3">
                {lead.nome}
                <Badge className={`${scoreBadge.color} text-foreground`}>
        ...
        {/* Lead Info Card */}
        <Card className="bg-muted/50 border-slate-700">
          <CardHeader>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="flex items-center gap-2">
              <Badge className={`${statusColors[lead.status]} text-foreground`}>
                {statusLabels[lead.status]}
              </Badge>
              <Badge className={`${priorityColors[lead.priorita]} text-foreground`}>
            ...
            {lead.messaggio && (
              <div className="col-span-full">
                <div className="flex items-start gap-3 text-slate-300 bg-muted/40 p-4 rounded-lg">
        ...
        {enrichment ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {enrichment.profilo_psicografico.pain_points.map((p, i) => (
                        <Badge key={i} variant="secondary" className="bg-muted text-foreground text-xs">{p}</Badge>
                      ))}
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {enrichment.fascia_immobile.tipologie_consigliate.map((t, i) => (
                        <Badge key={i} variant="secondary" className="bg-muted text-foreground text-xs">{t}</Badge>
                      ))}
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {enrichment.fascia_immobile.zone_ideali.map((z, i) => (
                        <Badge key={i} variant="secondary" className="bg-muted text-foreground text-xs">{z}</Badge>
                      ))}
                    </div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {enrichment.buyer_persona.valori_chiave.map((v, i) => (
                        <Badge key={i} variant="secondary" className="bg-muted text-foreground text-xs">{v}</Badge>
                      ))}
                    </div>
                  </div>
                  <div>
              ...
              >
                <div className="space-y-3">
                  ...
                  <p className="text-sm bg-muted/50 p-2 rounded">{enrichment.strategia_followup.approccio_consigliato}</p>
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div key={i} className="bg-muted/50 rounded-lg p-4 space-y-2">
                      <div className="flex items-start justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-semibold text-foreground">{ob.obiezione}</span>
                        </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-foreground">{enrichment.punteggio_qualita.score}/100</p>
                    </div>
                  </div>
          ...
          <Card className="bg-muted/50 border-slate-700 border-dashed">
        ...
        {(enrichment || automationLogs.length > 0) && (
          <Card className="bg-card/60 border-slate-700">
            <CardHeader>
              <CardTitle className="text-foreground flex items-center gap-2">
        ...
        {automationLogs.length > 0 && (
          <Card className="bg-gradient-to-r from-violet-900/30 to-muted border-violet-500/20">
            <CardHeader>
              <CardTitle className="text-foreground flex items-center gap-2">
            ...
            <CardContent className="space-y-3">
              {automationLogs.map((log) => (
                <div key={log.id} className="bg-muted/40 p-3 rounded-lg flex items-start justify-between">
        ...
        {notes.length > 0 && (
          <Card className="bg-muted/50 border-slate-700">
            ...
            <CardContent className="space-y-3">
              {notes.map((note) => (
                <div key={note.id} className="bg-muted/40 p-3 rounded-lg">
