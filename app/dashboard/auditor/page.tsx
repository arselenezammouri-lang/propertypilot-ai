...
export default function AuditorPage() {
  ...
  const getGravitaColor = (gravita: string) => {
    switch (gravita) {
      ...
      default: return 'bg-amber-500/20 text-amber-500 border-border';
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-950 via-indigo-950 to-purple-950">
      ...
      <div className="relative container mx-auto px-4 py-8 max-w-7xl">
        ...
        >
          <Card className="mb-8 bg-gradient-to-br from-slate-900/90 to-slate-800/90 border-border shadow-2xl shadow-blue-500/10" data-testid="card-input">
            ...
            <div className="space-y-3 mb-6">
                ...
                <Select value={tipoTransazione} onValueChange={(v) => setTipoTransazione(v as 'vendita' | 'affitto' | 'affitto_breve')}>
                  <SelectTrigger className="bg-muted/50 border-border text-foreground" data-testid="select-tipo-transazione">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-3">
                ...
                <Select value={mercato} onValueChange={(v) => setMercato(v as 'italia' | 'usa')}>
                  <SelectTrigger className="bg-muted/50 border-border text-foreground" data-testid="select-mercato">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    {MERCATI.map((m) => (
              ...
              <div className="space-y-3">
                ...
                <Select value={obiettivo} onValueChange={(v) => setObiettivo(v as 'seo' | 'vendita' | 'luxury' | 'social')}>
                  <SelectTrigger className="bg-muted/50 border-border text-foreground" data-testid="select-obiettivo">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    {OBIETTIVI.map((o) => (
            ...
            <Tabs value={inputMode} onValueChange={(v) => setInputMode(v as 'text' | 'url')}>
              ...
              <TabsContent value="text" className="space-y-4 mt-4">
                <Textarea
                  ...
                  className="min-h-[200px] resize-y bg-muted/50 border-border text-foreground placeholder:text-muted-foreground/60"
                  value={textInput}
        ...
        {auditResult && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <Card className="bg-gradient-to-br from-slate-900/90 to-slate-800/90 border-2 border-amber-500/50 shadow-sm" data-testid="card-quality-score">
            ...
            <Card className="bg-gradient-to-br from-slate-900/90 to-slate-800/90 border-border" data-testid="card-structural-audit">
              <CardHeader>
                <CardTitle className="flex items-center gap-3 text-foreground">
              ...
              <CardContent className="space-y-6">
                {(['titolo', 'apertura', 'corpo', 'callToAction'] as const).map((key) => {
                  ...
                  return (
                    <div key={key} className="p-4 rounded-lg bg-muted/50 border border-blue-500/20">
            ...
            <Card className="bg-gradient-to-br from-slate-900/90 to-slate-800/90 border-emerald-500/30" data-testid="card-seo-audit">
              ...
              <CardContent className="space-y-6">
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="p-4 rounded-lg bg-muted/50 border border-red-500/20">
                ...
                {auditResult.seoAudit.problemiLeggibilita?.length > 0 && (
                  <div className="p-4 rounded-lg bg-muted/50 border border-amber-500/20">
            ...
            <Card className="bg-gradient-to-br from-slate-900/90 to-slate-800/90 border-pink-500/30" data-testid="card-emotional-audit">
              ...
              <CardContent className="space-y-6">
                <div className="p-4 rounded-lg bg-muted/50 border border-pink-500/20">
                  ...
                  {auditResult.redFlags.map((rf, i) => (
                    <div key={i} className={`p-4 rounded-lg border ${getGravitaColor(rf.gravita)}`}>
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="font-semibold text-foreground">{rf.problema}</span>
                      </div>
            ...
            <Card className="bg-gradient-to-br from-slate-900/90 to-slate-800/90 border-border" data-testid="card-suggestions">
              <CardHeader>
                <CardTitle className="flex items-center gap-3 text-foreground">
            ...
            <Card className="bg-gradient-to-br from-blue-950/50 to-purple-950/50 border-2 border-primary/30 shadow-2xl shadow-purple-500/20" data-testid="card-optimized-version">
              <CardHeader>
                <CardTitle className="flex items-center justify-between text-foreground">
                  <div className="flex items-center gap-3">
              ...
              <CardContent className="space-y-6">
                <div className="p-4 rounded-lg bg-purple-500/10 border border-border">
                  ...
                  <p className="text-xl font-bold text-foreground">{auditResult.optimizedVersion.titolo}</p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-amber-500/10 border border-border">
                  <div className="flex items-center justify-between mb-2">
                ...
                <div className="p-4 rounded-lg bg-muted/50 border border-slate-600/30">
                  <div className="flex items-center justify-between mb-2">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Card className="bg-gradient-to-br from-slate-900/90 to-slate-800/90 border-border" data-testid="card-target-buyer">
                <CardHeader>
                  <CardTitle className="flex items-center gap-3 text-foreground">
