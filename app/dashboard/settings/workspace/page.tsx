      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-bold text-foreground">{t.heroTitle}</h1>
          ...
          {isTrial && (
            <div className="mt-4 p-4 bg-gradient-to-r from-purple-500/10 to-cyan-500/10 border border-border rounded-lg">
                  ...
                  <div className="flex items-start gap-4 flex-1">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        {module.trialEnabled && (
                          <Badge className="bg-cyan-500 text-foreground text-xs">Trial</Badge>
                        )}
                        <Badge
                          variant="outline"
                          className={`text-xs ${
                            module.requiredPlan === 'AGENCY'
                              ? 'border-primary/30 text-purple-400'
