...
export default function BillingPage() {
    ...
    return (
      <div className="container max-w-6xl py-10 space-y-6">
        <h1 className="text-4xl font-extrabold mb-3" data-testid="heading-billing">
          {billingT.title} <span className="text-gradient-blue">{billingT.titleAccent}</span>
        </h1>
        <div className="pp-card p-6 border-orange-500/30 flex flex-col items-center justify-center min-h-[280px] gap-4">
  ...
  const getPlanTheme = () => {
    switch (currentPlan) {
      case 'starter':
        return {
          cardClass: 'border-2 border-border shadow-sm',
      ...
      case 'pro':
        return {
          cardClass: 'border-2 border-amber-200 shadow-sm',
      ...
      case 'agency':
        return {
          cardClass: 'border-2 border-blue-600/30 shadow-sm',
          iconBg: 'from-blue-600/30 to-blue-600/10',
      ...
      default:
        return {
          ...
          iconBg: 'from-muted/80 to-muted/30',
  ...
  return (
    <div className="container max-w-6xl py-10 space-y-10 md:py-12 md:space-y-12">
      ...
      <div className={`pp-card p-8 md:p-10 ${theme.cardClass} hover-lift animate-fade-in-up delay-100 relative overflow-hidden`} data-testid="card-current-plan">
            ...
            {isFreePlan && (
              <>
                <Button
                  ...
                  variant="outline"
                  className="text-lg px-8 py-6 border-2 border-border hover:border-blue-500 hover:bg-primary/10 transition-all"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="text-lg px-8 py-6 border-2 border-blue-600/30 hover:border-blue-600 hover:bg-blue-600/10 transition-all"
                >
                  {checkoutMutation.isPending ? (
                    <Loader2 className="h-5 w-5 animate-spin mr-2" />
                  ) : (
      ...
      {(isFreePlan || currentPlan === 'starter') && (
        <div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {isFreePlan && (
              <div className="pp-card p-6 md:p-8 border-2 border-border shadow-sm hover-lift animate-fade-in-up delay-300 relative overflow-hidden group" data-testid="card-plan-starter">
                <div className="absolute top-0 right-0 w-28 h-28 bg-gradient-to-br from-blue-500/30 to-transparent rounded-bl-[4rem] opacity-50 group-hover:opacity-70 transition-opacity" />
                ...
                <div className="relative">
                  ...
                  <div className="mb-6">
                    <span className="text-4xl font-black text-gradient-blue">{formatCurrencyForLocale(197, locale as Locale, currency)}</span>
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="w-full text-base py-5 border-2 border-primary/30 hover:border-blue-500 hover:bg-primary/10 transition-all"
                  >
                    {checkoutMutation.isPending ? (
                      <Loader2 className="h-5 w-5 animate-spin mr-2" />
                    ) : (
            ...
            <div className="pp-card p-6 md:p-8 border-2 border-amber-300 shadow-sm hover-lift animate-fade-in-up delay-350 relative overflow-hidden group" data-testid="card-plan-pro">
              <div className="absolute top-0 right-0 w-28 h-28 bg-gradient-to-br from-amber-100 to-transparent rounded-bl-[4rem] opacity-50 group-hover:opacity-70 transition-opacity" />
              
              <div className="absolute top-3 right-3">
                <span className="pp-badge shadow-sm text-xs">
            ...
            <div className="pp-card p-6 md:p-8 border-2 border-blue-600/30 shadow-sm hover-lift animate-fade-in-up delay-400 relative overflow-hidden group" data-testid="card-plan-agency">
              <div className="absolute top-0 right-0 w-28 h-28 bg-gradient-to-br from-blue-600/30 to-transparent rounded-bl-[4rem] opacity-50 group-hover:opacity-70 transition-opacity" />
              ...
              <div className="relative">
                ...
                <div className="mb-6">
                  <span className="text-4xl font-black text-gradient-blue">{formatCurrencyForLocale(897, locale as Locale, currency)}</span>
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full text-base py-5 border-2 border-blue-600/50 hover:border-blue-600 hover:bg-blue-600/10 transition-all"
                >
                  {(checkoutMutation.isPending || upgradeMutation.isPending) ? (
                    <Loader2 className="h-5 w-5 animate-spin mr-2" />
                  ) : (
      ...
      <div className="animate-fade-in-up delay-500">
        ...
        <div className="pp-card p-8 md:p-10 border-2 border-orange-300 shadow-sm hover-lift relative overflow-hidden group" data-testid="card-boost-package">
          ...
          <div className="relative grid md:grid-cols-2 gap-8">
            <div>
              <div className="w-14 h-14 bg-gradient-to-br from-orange-100 to-orange-50 rounded-2xl flex items-center justify-center mb-4 shadow-sm">
