...
export default function AnalyzePage() {
  ...
  const getScoreBg = (score: number) => {
    if (score >= 80) return "bg-green-500/20 border-border";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <nav className="flex items-center space-x-2 md:space-x-4">
              <ThemeToggle />
              <Link href="/dashboard">
                <Button variant="outline" size="sm" className="border-blue-600/30 hover:border-blue-600 hover:bg-blue-600/10 transition-all" data-testid="button-back-dashboard" aria-label={t.back}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="mb-10 md:mb-14 animate-fade-in-up">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-3 md:mb-4">
            {t.heroTitleLead} <span className="text-gradient-blue">{t.heroTitleAccent}</span>{t.heroTitleTail ? ` ${t.heroTitleTail}` : ""}
          </h2>
        ...
        <div className="pp-card p-8 mb-8 animate-fade-in-up" data-testid="card-analyze-input">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <Input
                ...
                className="pl-12 h-14 text-lg border-blue-600/30 focus:border-blue-600 bg-background/50"
                disabled={isLoading}
            ...
            <Button 
              ...
              disabled={isLoading}
              className="h-14 px-8 bg-gradient-to-r from-blue-600 to-blue-500 hover:opacity-90 transition-all text-lg font-semibold shadow-sm"
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <Badge variant="outline" className="border-border text-blue-500">
            ...
            <Badge variant="outline" className="border-border text-green-500">
        ...
        {error && (
          <div className="pp-card p-6 mb-8 border-red-500/30 bg-red-500/10 animate-fade-in-up" data-testid="card-error">
        ...
        {isLoading && (
          <div className="pp-card p-12 animate-fade-in-up" data-testid="card-loading">
            <div className="space-y-6">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-16 h-16 bg-gradient-ai-aurora rounded-2xl flex items-center justify-center animate-pulse shadow-sm">
                  <Loader2 className="h-8 w-8 text-foreground animate-spin" />
                </div>
                <div className="flex-1">
                  <div className="h-6 bg-muted/40 rounded-lg w-48 mb-2 animate-pulse" />
        ...
        {scrapedData && analysis && !isLoading && (
          <div className="space-y-8 animate-fade-in-up">
            <div className="grid lg:grid-cols-3 gap-6">
              <div className={`pp-card p-8 text-center border ${getScoreBg(analysis.qualityScore)}`} data-testid="card-quality-score">
              ...
              <div className={`pp-card p-8 text-center border ${getScoreBg(analysis.seoAnalysis.score)}`} data-testid="card-seo-score">
              ...
              <div className="pp-card p-8 border-emerald-500/30" data-testid="card-target-buyer">
                <Target className="h-12 w-12 mx-auto mb-4 text-emerald-500" />
            ...
            <div className="pp-card p-6 border-border" data-testid="card-scraped-data">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <p className="font-semibold text-amber-500">{scrapedData.price || t.notAvailable}</p>
                </div>
                <div>
            ...
            <Tabs defaultValue="analysis" className="w-full">
              <TabsList className="grid w-full grid-cols-3 mb-6 h-14 bg-background/50 border border-border">
                <TabsTrigger value="analysis" className="text-base data-[state=active]:bg-blue-600 data-[state=active]:text-foreground" data-testid="tab-analysis">
                  <Search className="mr-2 h-4 w-4" />
                  {t.analysis}
                </TabsTrigger>
                <TabsTrigger value="improvements" className="text-base data-[state=active]:bg-blue-500 data-[state=active]:text-foreground" data-testid="tab-improvements">
                  <Lightbulb className="mr-2 h-4 w-4" />
                  {t.improvements}
                </TabsTrigger>
                <TabsTrigger value="rewrite" className="text-base data-[state=active]:bg-emerald-500 data-[state=active]:text-foreground" data-testid="tab-rewrite">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {analysis.seoAnalysis.keywords.map((keyword, i) => (
                          <Badge key={i} variant="secondary" className="bg-blue-500/20 text-blue-500 border-border">
                            {keyword}
                          </Badge>
                        ))}
                      </div>
              ...
              <TabsContent value="improvements" className="space-y-6" data-testid="content-improvements">
                <div className="pp-card p-6 border-amber-200">
                  ...
                  <ul className="space-y-3">
                    {analysis.improvements.map((improvement, i) => (
                      <li key={i} className="flex items-start gap-3 p-3 bg-amber-50 rounded-lg border border-amber-400/20">
                        <div className="w-6 h-6 rounded-full bg-amber-100 flex items-center justify-center text-sm font-bold text-amber-500 flex-shrink-0">
                          {i + 1}
                        </div>
              ...
              <TabsContent value="rewrite" className="space-y-6" data-testid="content-rewrite">
                <div className="pp-card p-6 border-emerald-500/30">
                ...
                <div className="pp-card p-6 border-blue-600/30">
                  ...
                  <div className="space-y-3">
                    {analysis.rewrittenListing.titles.map((title, i) => (
                      <div key={i} className="flex items-center justify-between p-3 bg-blue-600/10 rounded-lg border border-blue-600/20">
                        <div className="flex items-center gap-3">
                          <span className="w-6 h-6 rounded-full bg-blue-600/30 flex items-center justify-center text-sm font-bold text-blue-600">
                            {i + 1}
                          </span>
