          ...
          <div className="lg:col-span-1">
            <Card>
              <CardHeader>
                ...
                {filters.length === 0 && (
                  <div className="mt-2 p-3 bg-purple-500/10 border border-border rounded-lg">
              ...
              <CardContent>
                {loading ? (
                  ...
                  <div className="text-center py-12 space-y-4">
                    ...
                    <div className="mt-4 p-4 bg-purple-500/10 border border-border rounded-lg max-w-md mx-auto">
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  {(userPlan === 'pro' || userPlan === 'agency') && (
                                    <Button
                                      ...
                                      className="border-primary/30 text-purple-400 hover:bg-purple-500/10 hover:border-purple-500"
                                    >
          ...
          {selectedListing && (
            <div className="space-y-4">
              ...
              {calculateMarketGap(selectedListing) && calculateMarketGap(selectedListing)! > 0 && (
                <div className="bg-gradient-to-r from-green-500/10 to-cyan-500/10 border border-border rounded-lg p-4">
