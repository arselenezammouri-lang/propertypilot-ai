    ...
    <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 md:h-20">
            <Link href="/dashboard" className="flex items-center space-x-3 group">
              <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-blue-500 via-violet-500 to-purple-600 rounded-2xl flex items-center justify-center transition-all duration-300 group-hover:scale-110 group-hover:rotate-3 shadow-sm">
            ...
            <nav className="flex items-center space-x-2 md:space-x-4">
              <span className="hidden md:inline-flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-blue-500/20 to-violet-500/20 rounded-full border border-border">
      ...
      <div className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col">
        ...
        <div className="mb-6 animate-fade-in-up">
          <div className="pp-card p-6 border-2 border-border bg-gradient-to-br from-blue-500/5 via-violet-500/5 to-purple-500/5">
            <div className="flex items-start gap-4">
              <div className="w-14 h-14 bg-gradient-to-br from-blue-500 via-violet-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-sm flex-shrink-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              {localizedQuickSuggestions.map((suggestion, index) => (
                <button
                  ...
                  className="flex items-center gap-3 p-4 rounded-xl border-2 border-border hover:border-violet-500/50 hover:bg-violet-500/5 transition-all text-left group disabled:opacity-50"
        ...
        <div className="flex-1 pp-card overflow-hidden flex flex-col min-h-[400px] animate-fade-in-up delay-150" data-testid="chat-container">
          ...
          <div className="p-4 border-t border-border">
            <div className="flex gap-3">
              <Input
                ...
                disabled={chatMutation.isPending}
                className="flex-1 h-12 text-base border-2 border-border focus:border-violet-500"
