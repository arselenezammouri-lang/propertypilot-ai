      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 h-12 bg-background/50 border-border focus:border-purple-500 text-foreground"
            />
          </div>
        </div>
                ...
                <div className="space-y-3">
                  {section.articles.map((article) => (
                    <Link
                      ...
                      className="block p-3 rounded-lg bg-white/[0.03] border border-white/10 hover:border-primary/30 transition-colors group"
                    >
                      <div className="flex items-start justify-between gap-2">
                        <div className="flex-1">
                          <h3 className="text-sm font-semibold text-foreground mb-1 group-hover:text-purple-400 transition-colors">
                            {article.title}
                          </h3>
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          <Card className="border-border bg-card">
            <CardHeader>
              <CardTitle className="text-lg text-foreground">{t.quickStartTitle}</CardTitle>
            </CardHeader>
            <CardContent>
              ...
              <Link href="/docs/getting-started/welcome">
                <Button variant="outline" className="w-full border-border text-cyan-400 hover:bg-cyan-500/10">
                  {t.quickStartBtn}
                </Button>
              </Link>
            </CardContent>
          ...
          <Card className="border-border bg-card">
            <CardHeader>
              <CardTitle className="text-lg text-foreground">{t.bestPracticesTitle}</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-gray-300 mb-4">
                {t.bestPracticesDesc}
              ...
              <Link href="/docs/prospecting/arbitrage">
                <Button variant="outline" className="w-full border-border text-purple-400 hover:bg-purple-500/10">
                  {t.bestPracticesBtn}
                </Button>
              </Link>
            </CardContent>
          ...
          <Card className="border-border bg-card">
            <CardHeader>
              <CardTitle className="text-lg text-foreground">{t.goalsTitle}</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-gray-300 mb-4">
                {t.goalsDesc}
              ...
              <Link href="/docs/ai-voice/call-scripts">
                <Button variant="outline" className="w-full border-border text-green-400 hover:bg-green-500/10">
                  {t.goalsBtn}
                </Button>
              </Link>
            </CardContent>
