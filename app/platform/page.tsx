  ...
  return (
    <main id="main-content" className={`min-h-screen bg-background text-foreground relative overflow-hidden font-['Inter_Tight',sans-serif] ${locale === "ar" ? "rtl" : "ltr"}`}>
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 right-1/4 w-[800px] h-[800px] bg-primary/10 rounded-full blur-3xl"></div>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-white/5 border-b border-white/10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <a href="#features">
              <Button variant="ghost" size="sm" className="text-gray-300 hover:text-foreground transition-all active:scale-95">
            ...
            <Link href="/auth/signup">
              <Button size="sm" className="bg-gradient-to-r from-[#9333ea] to-[#9333ea]/80 hover:from-[#9333ea] hover:to-[#9333ea]/90 text-foreground border-0 shadow-[0_0_15px_rgba(147,51,234,0.4)] hover:shadow-[0_0_25px_rgba(147,51,234,0.6)] transition-all active:scale-95">
          ...
          <div className="lg:hidden absolute top-full left-0 right-0 bg-white/5 backdrop-blur-md border-b border-white/10 animate-fade-in-down">
            <div className="container mx-auto px-4 py-4 space-y-2">
              <a href="#features" onClick={() => setMobileMenuOpen(false)}>
                <Button variant="ghost" className="w-full justify-start text-gray-300 hover:text-foreground">
                  {t.landing.nav.features}
                </Button>
              </a>
              ...
              <Link href="/auth/signup" onClick={() => setMobileMenuOpen(false)}>
                <Button className="w-full bg-gradient-to-r from-[#9333ea] to-[#9333ea]/80 hover:from-[#9333ea] hover:to-[#9333ea]/90 text-foreground">
                  {t.landing.nav.getStarted}
                </Button>
              </Link>
            </div>
      ...
      >
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="text-center mb-12">
            ...
            <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-primary/10 border border-[#06b6d4]/30 mb-8 relative backdrop-blur-md">
            ...
            <div className="flex items-center justify-center gap-6 mb-8 text-lg">
              <div className="flex items-center gap-2">
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="w-10 h-10 rounded-full bg-gradient-to-br from-purple-400 to-cyan-400 border-2 border-background"></div>
                  ))}
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
              <Link href="/auth/signup" aria-label="Sign up for PropertyPilot AI">
                <Button 
                  size="lg" 
                  className="text-xl px-12 py-7 bg-gradient-to-r from-[#9333ea] to-[#9333ea]/90 hover:from-[#9333ea] hover:to-[#9333ea] text-foreground border-0 shadow-[0_0_30px_rgba(147,51,234,0.5)] hover:shadow-[0_0_40px_rgba(147,51,234,0.7)] relative overflow-hidden group transition-all active:scale-95"
              ...
              <Link href="/dashboard" aria-label="View demo dashboard">
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="text-xl px-12 py-7 border-white/20 text-foreground/90 hover:bg-white/5 backdrop-blur-md transition-all active:scale-95 hover:border-white/30 hover:shadow-[0_0_20px_rgba(147,51,234,0.2)]"
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card 
                key={idx} 
                className="pp-card fade-on-scroll border-white/10"
      ...
      >
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 fade-on-scroll">
            ...
            <Card className="pp-card border-white/10 hover:border-[#9333ea]/30">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-foreground">{t.landing.searchEngine.step1.title}</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="pp-card border-white/10 hover:border-[#06b6d4]/30">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-foreground">{t.landing.searchEngine.step2.title}</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-400 text-sm mb-4">
            ...
            <Card className="pp-card border-white/10 hover:border-[#9333ea]/30">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-foreground">{t.landing.searchEngine.step3.title}</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-400 text-sm mb-4">
            ...
            <Card className="pp-card border-white/10 hover:border-[#06b6d4]/30">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-foreground">{t.landing.searchEngine.step4.title}</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-400 text-sm mb-4">
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="space-y-8 fade-on-scroll">
            {[
              ...
              <Card 
                key={idx}
                className="pp-card border-white/10 hover:border-[#9333ea]/30"
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card 
                key={idx} 
                className="pp-card border-white/10 hover:border-[#9333ea]/30 fade-on-scroll"
                style={{ animationDelay: `${idx * 100}ms` }}
              >
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="text-center mt-12 fade-on-scroll">
            ...
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-white/5 backdrop-blur-md border border-white/10 rounded-lg">
              ...
              <span className="text-sm text-foreground/90">{t.landing.aria.availableFree}</span>
            </div>
          </div>
        </div>
      </motion.section>
        ...
        <div className="container mx-auto max-w-7xl">
                ...
                <thead>
                  <tr className="border-b border-white/10">
                    ...
                    <th className="text-center p-4">
                      <div className="pp-card border-white/10 rounded-lg p-4">
                    ...
                    <th className="text-center p-4">
                      <div className="pp-card border-white/10 rounded-lg p-4">
                        <div className="text-2xl font-bold text-foreground mb-1">STARTER</div>
                        <div className="text-3xl font-extrabold text-foreground mb-2">
                    ...
                    <th className="text-center p-4 relative">
                      <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 bg-gradient-to-r from-[#9333ea] to-[#06b6d4] text-foreground text-xs font-bold rounded-full z-10 backdrop-blur-md border border-white/20">
                        {t.landing.pricing.bestValue}
                      </div>
                      <div className="pp-card border-2 border-[#9333ea]/50 rounded-lg p-4 shadow-[0_0_30px_rgba(147,51,234,0.3)] relative">
          ...
          <div className="grid md:grid-cols-4 gap-6 mt-12 fade-on-scroll">
            <Link href="/auth/signup" className="w-full">
              <Button variant="outline" className="w-full border-white/20 text-foreground/90 hover:bg:white/5 backdrop-blur-md transition-all active:scale-95 hover:border-white/30">
          ...
          <div className="mt-16 fade-on-scroll">
            <div className="pp-card rounded-2xl p-8 bg-gradient-to-br from-amber-500/15 via-orange-500/10 to-transparent relative overflow-hidden border-2 border-amber-400/60 shadow-[0_0_50px_rgba(245,158,11,0.4),0_0_100px_rgba(251,191,36,0.2)] hover:shadow-[0_0_70px_rgba(245,158,11,0.6),0_0_120px_rgba(251,191,36,0.3)] transition-all duration-500 hover:border-amber-400/80 ring-2 ring-amber-400/30 ring-offset-2 ring-offset-background agency-boost-card">
              <div className="absolute -top-3 right-4 px-4 py-1.5 bg-gradient-to-r from-orange-500 to-amber-500 text-foreground text-xs font-bold rounded-full z-10 backdrop-blur-md border border-white/20">
                PREMIUM SERVICE
              </div>
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-3xl font-bold text-foreground">Agency Boost</h3>
      ...
      <section className="py-24 px-4 bg-muted/30">
        <div className="container mx-auto max-w-4xl text-center fade-on-scroll">
          <Card className="pp-card border-white/10 backdrop-blur-md">
            <CardHeader>
              <CardTitle className="text-4xl md:text-5xl mb-4 text-foreground">
                {t.landing.cta.title}
              </CardTitle>
      ...
      {/* Footer */}
      <footer className="py-12 px-4 bg-background border-t border-white/10">
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                <PropertyPilotLogo className="h-6 w-6" />
                <span className="text-xl font-bold text-foreground">PropertyPilot AI</span>
              </div>
            ...
            <div>
              <h3 className="text-foreground font-semibold mb-4">{t.landing.footer.product}</h3>
            ...
            <div>
              <h3 className="text-foreground font-semibold mb-4">{t.landing.footer.company}</h3>
              <ul className="space-y-2 text-gray-400 text-sm font-light">
