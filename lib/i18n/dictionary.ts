  ...
  it: {
    ...
    landing: {
      ...
      hero: {
        ...
        titleAI: 'AI',
        socialProof: 'Costruito per',
        socialProofAgencies: 'agenti immobiliari in Europa',
        socialProofLocation: 'Italia, Francia, Spagna, Germania, UK, Portogallo',
      ...
      testimonials: {
        ...
        subtitle: 'Progettato da chi conosce il settore immobiliare europeo',
        testimonial1: {
          name: 'AI Listing Engine',
          role: 'GPT-4o • 6 lingue • 3 stili',
          content: 'Genera descrizioni professionali per portali immobiliari in 8 secondi. Stile Standard, Luxury o Investment. Ottimizzato per Idealista, Immobiliare.it, Rightmove.',
        },
        testimonial2: {
          name: 'Compliance Shield',
          role: '6 Paesi EU • 35+ regole',
          content: 'Verifica automatica APE, DPE, EPC, GEG prima della pubblicazione. Italia, Francia, Spagna, Germania, UK e Portogallo coperti.',
        },
        testimonial3: {
          name: 'Voice Agent AI',
          role: 'Bland AI • ElevenLabs • 6 lingue',
          content: 'Chiamate automatiche multilingua per qualificare lead, gestire obiezioni e prenotare visite. Trascrizione e aggiornamento CRM automatici.',
        },
      },
      aria: {
  ...
  en: {
    ...
    landing: {
      ...
      hero: {
        ...
        titlePart2: 'Agent',
        titleAI: 'AI',
        socialProof: 'Built for',
        socialProofAgencies: 'real estate professionals across Europe',
        socialProofLocation: 'Italy, France, Spain, Germany, UK, Portugal',
  ...
  es: {
    ...
    landing: {
      ...
      hero: {
        ...
        titleAI: 'IA',
        socialProof: 'Creado para',
        socialProofAgencies: 'profesionales inmobiliarios en Europa',
        socialProofLocation: 'Italia, Francia, España, Alemania, UK, Portugal',
  ...
  fr: {
    ...
    landing: {
      ...
      hero: {
        ...
        titleAI: 'IA',
        socialProof: 'Conçu pour',
        socialProofAgencies: 'professionnels immobiliers en Europe',
        socialProofLocation: 'Italie, France, Espagne, Allemagne, UK, Portugal',
  ...
  de: {
    ...
    landing: {
      ...
      hero: {
        ...
        titlePart2: 'Makler',
        titleAI: 'KI',
        socialProof: 'Entwickelt für',
        socialProofAgencies: 'Immobilienprofis in Europa',
        socialProofLocation: 'Italia, Francia, Spagna, Germania, UK, Portogallo',
