  ...
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
        <section className="pp-card border border-border p-6 md:p-8 rounded-xl">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                {copy.guaranteeBodyStart} <strong className="text-emerald-500">{copy.guaranteeBodyStrong}</strong>{" "}
        ...
        <section className="pp-card border border-border p-6 md:p-8 rounded-xl">
          ...
          <div className="space-y-4">
            <div className="bg-blue-500/5 p-4 rounded-lg border border-blue-500/20">
              <h3 className="font-semibold text-blue-500 mb-2">{copy.freeTrialTitle}</h3>
            ...
            <div className="bg-emerald-500/5 p-4 rounded-lg border border-emerald-500/20">
              <h3 className="font-semibold text-emerald-500 mb-2">{copy.guarantee14Title}</h3>
          ...
          <div className="space-y-4">
            {copy.process.map((item) => (
              <div key={`${item.step}-${item.title}`} className="flex items-start gap-4">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold ${item.step === "✓" ? "bg-emerald-500/20 text-emerald-500" : "bg-blue-600/20 text-blue-600"}`}>
                  {item.step}
                </div>
                <div>
        ...
        <section className="pp-card border border-border p-6 md:p-8 rounded-xl border-2 border-blue-600/30">
          <h2 className="text-xl font-bold mb-4 flex items-center gap-2">
          ...
          <ul className="text-muted-foreground mt-4 space-y-2">
            <li>
              ...
              <a href="mailto:billing@propertypilotai.com" className="text-blue-600 hover:underline">
                billing@propertypilotai.com
              </a>
            </li>
            <li>
              <strong>{copy.supportEmail}</strong>{" "}
              <a href="mailto:support@propertypilotai.com" className="text-blue-600 hover:underline">
