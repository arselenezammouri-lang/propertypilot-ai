  ...
  return (
    <Card className="mb-8 border-2 border-primary/50 bg-gradient-to-r from-primary/5 to-primary/10 animate-fade-in-up overflow-hidden relative" data-testid="pending-checkout-banner">
      <button
        ...
        className="absolute top-3 right-3 p-1 rounded-full hover:bg-background/10 transition-colors z-10"
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Button
              ...
              size="lg"
              className={`bg-gradient-to-r ${details.color} hover:opacity-90 text-foreground shadow-lg min-w-[200px]`}
