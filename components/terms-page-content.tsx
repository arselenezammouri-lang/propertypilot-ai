        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-3xl md:text-4xl font-extrabold" data-testid="heading-terms">
              {copy.title} <span className="gradient-text-purple">{copy.highlight}</span>
            </h1>
                  ...
                  {section.contacts.map((contact) => (
                    <li key={contact}>
                      {contact.startsWith("Email:")
                        ? <>Email: <a href="mailto:legal@propertypilotai.com" className="text-royal-purple hover:underline">legal@propertypilotai.com</a></>
                        : <>Support: <a href="mailto:support@propertypilotai.com" className="text-royal-purple hover:underline">support@propertypilotai.com</a></>}
                    </li>
                  ))}
                </ul>
              ) : null}
