...
export function OnboardingTooltip({
  ...
  return (
    <div
      ref={tooltipRef}
      className="fixed z-[9999] w-80 bg-gradient-to-br from-blue-600/95 to-blue-500/95 backdrop-blur-sm border-2 border-blue-600/50 rounded-xl shadow-2xl p-4 animate-fade-in"
    ...
    >
      ...
      <p className="text-foreground/90 text-sm mb-4 leading-relaxed">{description}</p>
