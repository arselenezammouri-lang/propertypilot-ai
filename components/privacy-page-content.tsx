              ...
              {section.body?.map((paragraph) => (
                <p key={paragraph} className="text-white/70 leading-relaxed mt-4 first:mt-0">
                  {paragraph.includes("privacy@propertypilotai.com") && paragraph.startsWith("Email:")
                    ? <>Email: <a href="mailto:privacy@propertypilotai.com" className="text-royal-purple hover:underline">privacy@propertypilotai.com</a></>
                    : paragraph}
                </p>
              ))}
              ...
              {section.note ? (
                <p className="text-white/70 leading-relaxed mt-4">
                  {section.note.includes("www.garanteprivacy.it")
                    ? <>Hai il diritto di presentare reclamo al Garante per la Protezione dei Dati Personali (<a href="https://www.garanteprivacy.it" target="_blank" rel="noopener noreferrer" className="text-royal-purple hover:underline">www.garanteprivacy.it</a>).</>
                    : section.note.includes("privacy@propertypilotai.com")
                    ? <>Per esercitare questi diritti, contattaci a <a href="mailto:privacy@propertypilotai.com" className="text-royal-purple hover:underline">privacy@propertypilotai.com</a></>
                    : section.note}
                </p>
              ) : null}
            </section>
