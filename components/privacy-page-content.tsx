        ...
        sections: [
          ...
          },
          {
            ...
            items: [
              ...
              "Supabase: Per hosting database e autenticazione (EU — Irlanda)",
              "OpenAI: Per generazione contenuti AI (dati anonimizzati)",
              "Anthropic: AI di backup (dati anonimizzati)",
              "Vercel: Per hosting della piattaforma e CDN",
              "Resend: Per invio email transazionali",
              "Replicate: Per Visual AI (staging, enhancement foto)",
              "ElevenLabs: Per sintesi vocale e clonazione voce",
              "Bland AI: Per chiamate vocali automatiche",
              "Twilio: Per SMS e gestione numeri telefonici",
              "Meta: Per WhatsApp Business e social publishing",
              "Google: Per mappe, OAuth e geocoding",
              "Sentry: Per monitoraggio errori (nessun dato personale)",
              "DocuSign/YouSign: Per firme elettroniche",
            ],
            note: "Tutti i fornitori offrono certificazioni SOC 2 o equivalenti. Dati trattati in EU dove possibile.",
          },
          {
            icon: UserCheck,
            color: "text-blue-500",
        ...
        sections: [
          ...
          },
          {
            ...
            items: [
              ...
              "OpenAI: AI content generation (anonymized data)",
              "Anthropic: backup AI processing (anonymized data)",
              "Vercel: platform hosting and CDN",
              "Resend: transactional email delivery",
              "Replicate: Visual AI (photo enhancement, virtual staging)",
              "ElevenLabs: voice synthesis and cloning",
              "Bland AI: automated voice calls",
              "Twilio: SMS and phone number management",
              "Meta: WhatsApp Business API and social publishing",
              "Google: Maps, OAuth, and geocoding",
              "Sentry: error monitoring (no PII collected)",
              "DocuSign/YouSign: electronic signatures",
            ],
            note: "All providers offer SOC 2 or equivalent security certifications. Data processed in EU where possible.",
          },
          {
            icon: UserCheck,
            color: "text-blue-500",
