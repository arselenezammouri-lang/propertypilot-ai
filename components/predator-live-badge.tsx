...
export function PredatorLiveBadge({ className }: PredatorLiveBadgeProps) {
  ...
  return (
    <div className={`absolute top-4 right-4 z-50 ${className}`}>
      <Badge 
        className="bg-gradient-to-r from-purple-600 via-cyan-500 to-purple-600 text-foreground font-bold px-4 py-2 shadow-lg shadow-purple-500/50 border border-cyan-400/50 animate-pulse"
      >
