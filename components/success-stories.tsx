...
const successStories: SuccessStory[] = [
  {
    id: "1",
    agent: "AI Listing Engine",
    location: "6 EU Languages",
    feature: "Price Drop Sniper",
    result: "Generate portal-ready descriptions in seconds",
  ...
  },
  {
    ...
    location: "6 EU Countries",
    feature: "Virtual Staging 3D",
    result: "35+ country-specific compliance rules",
    icon: <Sparkles className="h-5 w-5" />,
    color: "text-purple-400",
  },
  {
    id: "3",
    agent: "Voice Agent AI",
    location: "Milano",
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant="outline" className="border-border text-purple-400">
                      {story.feature}
                    </Badge>
                  </div>
