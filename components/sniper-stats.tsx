...
export function SniperStats() {
  ...
  if (loading) {
    return (
      <>
        <div className="pp-card p-8 md:p-10 relative overflow-hidden group hover-lift animate-fade-in-up delay-400">
        ...
        <div className="pp-card p-8 md:p-10 relative overflow-hidden group hover-lift animate-fade-in-up delay-450">
  ...
  if (error || !stats) {
    return (
      <Card className="pp-card p-8 md:p-10 relative overflow-hidden">
        <CardHeader>
  ...
  return (
    <>
      ...
      <div className="pp-card p-8 md:p-10 relative overflow-hidden group hover-lift animate-fade-in-up delay-400" data-testid="card-price-drops">
        <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-red-500/30 to-transparent rounded-bl-[5rem] opacity-50 group-hover:opacity-70 transition-opacity" />
        <div className="flex items-start justify-between mb-6 relative">
          <div>
            <p className="text-sm font-bold text-muted-foreground mb-2 uppercase tracking-wider">{t.priceDropsToday}</p>
      ...
      <div className="pp-card p-8 md:p-10 relative overflow-hidden group hover-lift animate-fade-in-up delay-450" data-testid="card-expiration-opportunities">
        <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-cyan-500/30 to-transparent rounded-bl-[5rem] opacity-50 group-hover:opacity-70 transition-opacity" />
        <div className="flex items-start justify-between mb-6 relative">
          <div>
            <p className="text-sm font-bold text-muted-foreground mb-2 uppercase tracking-wider">{t.expirations}</p>
