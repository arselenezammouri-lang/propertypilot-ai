    ...
    <div className="space-y-6">
      <Card className="border-border bg-card">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-xl text-foreground">Analisi Tecnica Immagini IA</CardTitle>
            ...
            <Button
              ...
              className="bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-600 hover:to-purple-600 text-foreground"
            >
              {isScanning ? (
                <>
        ...
        <CardContent>
              ...
              <>
                ...
                {defects.map((defect) => (
                  ...
                  >
                    ...
                    {/* Tooltip on hover */}
                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 p-3 bg-[#1a1a1a] border border-border rounded-lg shadow-xl opacity-0 hover:opacity-100 transition-opacity pointer-events-none z-20">
                      <p className="text-xs font-semibold text-foreground mb-1">{defect.category}</p>
          ...
          {/* Aria Insight */}
          {ariaInsight && (
            <div className="mt-6 p-4 bg-gradient-to-r from-purple-500/10 to-cyan-500/10 border border-border rounded-lg">
        ...
        <Card className="border-border bg-card">
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <CardTitle className="text-lg text-foreground">Budget Riqualificazione Consigliato</CardTitle>
            </div>
          </CardHeader>
