...
export function GlobalStatsTicker() {
  ...
  return (
    <Card className="pp-card border-2 border-transparent bg-gradient-to-r from-background/80 via-background/60 to-background/80 backdrop-blur-xl shadow-lg relative overflow-hidden">
