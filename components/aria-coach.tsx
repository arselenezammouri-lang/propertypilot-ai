...
export function AriaCoach({ userName, userPlan = "free", userLocation }: AriaCoachProps) {
      ...
      <div className="fixed bottom-6 right-6 z-[9999]">
        <div className="relative group">
          ...
          >
            ...
            <Badge className={`absolute -top-1.5 -right-1.5 h-5 min-w-5 px-1 ${limitReached ? "bg-red-500 border-red-400" : "bg-gradient-to-r from-purple-500 to-cyan-500 text-foreground border-purple-300"} border font-mono text-[10px]`}>
          ...
          <div className="absolute -left-20 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
            <div className="bg-background/90 text-foreground text-[11px] font-medium px-3 py-1.5 rounded-lg border border-border whitespace-nowrap shadow-[0_0_20px_rgba(147,51,234,0.2)]">
              Aria AI
            </div>
          </div>
        </div>
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999] w-[400px] max-w-[calc(100vw-2rem)]">
      <Card className="border-2 border-cyan-500/40 bg-card backdrop-blur-xl shadow-[0_0_40px_rgba(34,211,238,0.15),inset_0_1px_0_rgba(34,211,238,0.1)] overflow-hidden">
        ...
        <CardHeader className="pb-3 border-b border-cyan-500/20 bg-muted/80">
        ...
        {!isMinimized && (
          <CardContent className="p-0">
            {/* Messages */}
            <div className="h-[400px] overflow-y-auto p-4 space-y-4 bg-muted/60 border-t border-cyan-500/10">
                  ...
                  <div
                    className={`max-w-[80%] rounded p-3 font-mono text-sm ${
                      message.role === "user"
                        ...
                        : "bg-card border border-cyan-500/20 text-cyan-100/90"
                    }`}
                  >
            ...
            {/* Input */}
            <div className="p-4 border-t border-cyan-500/20 bg-muted">
              <div className="flex items-center gap-2">
                ...
                <Input
                  ...
                  className="flex-1 bg-card border-border text-cyan-100 placeholder:text-cyan-600/60"
                  disabled={isLoading}
