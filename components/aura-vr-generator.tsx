...
export function AuraVRGenerator({ listingId, listingTitle, locale, location }: AuraVRGeneratorProps) {
  ...
  return (
    <div className="relative w-full">
      ...
      <Card className="pp-card border-2 border-transparent bg-gradient-to-br from-background/80 via-background/60 to-background/40 backdrop-blur-xl shadow-2xl relative overflow-hidden">
        ...
        <CardContent className="relative z-10 p-8 space-y-6">
            ...
            <div className="flex flex-col items-center justify-center py-12 space-y-6">
              <div className="relative">
                ...
                <Button
                  ...
                  size="lg"
                  className="relative z-10 bg-gradient-to-r from-[#9333ea] to-[#06b6d4] hover:from-[#9333ea]/90 hover:to-[#06b6d4]/90 text-foreground font-bold text-lg px-8 py-6 h-auto shadow-[0_0_30px_rgba(147,51,234,0.5)] hover:shadow-[0_0_40px_rgba(6,182,212,0.6)] transition-all duration-300 animate-pulse"
                >
          ...
          {isComplete && vrLink && (
            <div className="space-y-6 py-6">
              ...
              <div className="text-center space-y-2">
                ...
                <h4 className="text-xl font-bold text-foreground">{t.auraVR.result.title}</h4>
                <p className="text-sm text-muted-foreground">
              ...
              <div className="space-y-4">
                <div className="text-center">
                  <h5 className="text-sm font-semibold text-foreground mb-2">Triple Perspective - Massimo Standard di Lusso</h5>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  {/* Drone Mode */}
                  <Card 
                    className={`pp-card border-2 cursor-pointer transition-all ${
                      selectedView === 'drone' 
                  ...
                  >
                    <CardContent className="p-4 text-center space-y-2">
                      ...
                      <h6 className="font-semibold text-sm text-foreground">Drone Mode</h6>
                  ...
                  <Card 
                    className={`pp-card border-2 cursor-pointer transition-all ${
                      selectedView === 'cinematic' 
                        ...
                        : 'border-border hover:border-[#9333ea]/50'
                    }`}
                    onClick={() => setSelectedView('cinematic')}
                  >
                    <CardContent className="p-4 text-center space-y-2">
                      <Navigation className="h-8 w-8 text-[#9333ea] mx-auto" />
                      <h6 className="font-semibold text-sm text-foreground">Cinematic Walk</h6>
                  ...
                  >
                    <CardContent className="p-4 text-center space-y-2">
                      ...
                      <h6 className="font-semibold text-sm text-foreground">360° Panorama</h6>
              ...
              {/* Preview Card */}
              <Card className="pp-card border border-[#06b6d4]/30 bg-gradient-to-br from-[#06b6d4]/10 to-[#9333ea]/10 backdrop-blur-md">
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <Button
                      ...
                      variant="outline"
                      className="border-primary/30 text-[#06b6d4] hover:bg-primary/10 hover:border-[#06b6d4]"
                    >
          ...
          {isComplete && (
            <Card className="pp-card border border-[#9333ea]/30 bg-gradient-to-r from-[#9333ea]/10 to-transparent backdrop-blur-md">
