  ...
  return (
    <div className="w-full py-16 bg-gradient-to-b from-background to-purple-500/5">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Search Box */}
        <Card className="border-border bg-gradient-to-br from-purple-500/10 via-cyan-500/10 to-purple-500/10 shadow-xl">
          <CardContent className="p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-2xl mx-auto">
              <div className="flex-1 relative">
                ...
                <Input
                  ...
                  className="pl-10 h-12 text-lg bg-background/50 border-border focus:border-purple-500"
                />
              </div>
              <Button
                onClick={handleSearch}
                disabled={isSearching || !searchQuery.trim()}
                className="h-12 px-8 bg-gradient-to-r from-purple-500 to-cyan-500 hover:from-purple-600 hover:to-cyan-600 text-foreground font-bold"
              >
                {isSearching ? (
                  <>
            ...
            {isSearching && (
              <div className="mt-8 text-center">
                <div className="inline-flex items-center gap-3 px-6 py-4 bg-purple-500/20 border border-border rounded-lg">
                    ...
                    >
                      <CardContent className="p-5">
                        <div className="space-y-3">
                          ...
                          {/* Market Gap */}
                          <div className="flex items-center justify-between p-3 bg-green-500/10 border border-border rounded-lg">
                          ...
                          <Link href="/auth/signup">
                            <Button className="w-full bg-gradient-to-r from-purple-500 to-cyan-500 hover:from-purple-600 hover:to-cyan-600 text-foreground font-bold mt-4 relative shadow-lg shadow-purple-500/50 hover:shadow-purple-500/70 transition-all animate-pulse hover:animate-none">
