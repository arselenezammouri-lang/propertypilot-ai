...
export function Dashboard3DStats() {
  ...
  if (loading || !stats) {
    return (
      <>
        <div className="pp-card p-8 md:p-10 relative overflow-hidden group hover-lift animate-fade-in-up delay-300">
        ...
        <div className="pp-card p-8 md:p-10 relative overflow-hidden group hover-lift animate-fade-in-up delay-350">
  ...
  return (
    <>
      ...
      <div className="pp-card p-8 md:p-10 relative overflow-hidden group hover-lift animate-fade-in-up delay-300" data-testid="card-3d-projects">
        <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-purple-500/30 to-transparent rounded-bl-[5rem] opacity-50 group-hover:opacity-70 transition-opacity" />
        <div className="flex items-start justify-between mb-6 relative">
          <div>
            <p className="text-sm font-bold text-muted-foreground mb-2 uppercase tracking-wider">{t.projects3d}</p>
          ...
          <div className="w-12 h-12 md:w-14 md:h-14 bg-gradient-to-br from-purple-500/30 to-purple-500/10 rounded-2xl flex items-center justify-center shadow-sm">
            <Sparkles className="h-6 w-6 md:h-7 md:w-7 text-purple-400" />
          </div>
        </div>
      ...
      <div className="pp-card p-8 md:p-10 relative overflow-hidden group hover-lift animate-fade-in-up delay-350" data-testid="card-whatsapp-rate">
        <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-green-500/30 to-transparent rounded-bl-[5rem] opacity-50 group-hover:opacity-70 transition-opacity" />
        <div className="flex items-start justify-between mb-6 relative">
          <div>
            <p className="text-sm font-bold text-muted-foreground mb-2 uppercase tracking-wider">{t.whatsappOpen}</p>
