...
Vorremmo anche discutere un'opportunità di mandato esclusivo per accelerare la vendita.`;
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl bg-card border-red-500/30">
        <DialogHeader>
        ...
        <div className="space-y-4 mt-4">
          ...
          <Card className="bg-[#111111] border-red-500/30">
            ...
            <CardContent className="space-y-3">
              <div>
                ...
                <p className="text-foreground font-medium">{listing.location}</p>
              </div>
              <div className="flex items-center gap-4">
                ...
                {listing.price_drop_percentage && (
                  <Badge className="bg-red-500 text-foreground text-lg px-3 py-1">
          ...
          <Card className="bg-[#111111] border-border">
            ...
            <CardContent>
              <div className="bg-card rounded-lg p-4 border border-cyan-500/20">
