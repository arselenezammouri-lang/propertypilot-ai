    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between min-h-16 md:min-h-20">
          <Link
            href="/dashboard"
            className="flex items-center gap-3 group rounded-lg -m-2 p-2 min-h-11 touch-manipulation focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-royal-purple focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505]"
          >
