    ...
    <Card className="border-border bg-card">
      <CardHeader>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-xl text-foreground">Analisi del Territorio & Domanda</CardTitle>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="relative h-8 bg-gradient-to-r from-blue-500 via-orange-500 to-red-500 rounded-lg overflow-hidden">
              <div
                className="absolute top-0 left-0 h-full bg-muted backdrop-blur-sm transition-all duration-500"
        ...
        <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {insights.neighborhoodDNA.strengths.map((strength, idx) => (
                  <div
                    key={idx}
                    className="flex items-start gap-3 p-3 bg-green-500/10 border border-border rounded-lg"
                  >
                    <div className="text-2xl">{strength.icon}</div>
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        {getCategoryIcon(strength.category)}
                        <span className="text-sm font-semibold text-foreground">{strength.category}</span>
                      </div>
              ...
              <div className="space-y-2">
                {insights.neighborhoodDNA.weaknesses.map((weakness, idx) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <span className="text-sm font-semibold text-foreground">{weakness.category}</span>
                        <Badge
                          variant="outline"
                          className={`text-xs ${
          ...
          {/* Overall Score */}
          <div className="p-4 bg-gradient-to-r from-purple-500/10 to-cyan-500/10 border border-border rounded-lg">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm font-semibold text-foreground">DNA Score Complessivo</span>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 gap-3">
                  {insights.commercialIntelligence.recommendedActivities.map((activity, idx) => (
                    <div
                      key={idx}
                      className="p-4 bg-gradient-to-r from-purple-500/10 to-cyan-500/10 border border-border rounded-lg"
                    >
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex-1">
                          <p className="text-sm font-semibold text-foreground">{activity.activity}</p>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  {insights.commercialIntelligence.marketGaps.map((gap, idx) => (
                    <div
                      key={idx}
                      className="p-3 bg-amber-500/10 border border-border rounded-lg"
                    >
                      <div className="flex items-center gap-2 mb-1">
        ...
        <div className="p-4 bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-border rounded-lg">
          <div className="flex items-start gap-3">
