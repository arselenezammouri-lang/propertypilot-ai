              ...
              {scanSteps.map((step, idx) => (
                <div
                  ...
                  className={`flex items-center gap-3 p-3 rounded-lg border transition-all ${
                    idx < currentStep
                      ? "bg-green-500/10 border-border"
                      : idx === currentStep
                      ? "bg-purple-500/10 border-border"
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4 mt-6">
                {[1, 2, 3].map((deal) => (
                  <div
                    key={deal}
                    className="p-4 bg-gradient-to-br from-purple-500/10 to-cyan-500/10 border border-border rounded-lg"
                  >
                    <Badge className="bg-green-500 text-foreground mb-2">
              ...
              <div className="pt-6">
                <Link href="/dashboard/prospecting">
                  <Button
                    ...
                    className="bg-gradient-to-r from-purple-500 to-cyan-500 hover:from-purple-600 hover:to-cyan-600 text-foreground font-bold text-lg px-8 py-6"
                  >
